...
/* Most important routes to complete first:
* get /SRs/
* get /SRs/:SR#
* patch /SRs/SR#
* get /agents/:agent_id/SRs
*/
	...
	// V1 API ==================================================================
router.route('/v1') // TESTED works flawlessly (of course)

	.get(function(req, res) {
		res.json({ message: 'Igor2 API v1 Online.' });
		console.log('API test page queried.');
	});
		...
		function (error, response, body) {
		  if (!error && response.statusCode === 200) {
		    console.log(body); // print the web page
		  	...
		  	console.log('error updating SR# ' + req.params.sr_number + 
		  	' to new owner: ' + req.body.owner);
		  }
		});
	})
